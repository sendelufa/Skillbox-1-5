...
public class SignIn {
    ...
    public SignIn() {
        try {
            ...
            imgIcoPhone = ImageIO.read(new File("res/img/icon-phone.png"));
        } catch (IOException e) {
        ...
        //Set Fonts
        try {
            lbpDescPhone.setFont(Loader.getMainFont(14));
            lblBtnSend.setFont(Loader.getMainFont(30));
            txtPhone.setFont(Loader.getMainFont(32));
        ...
        lblBtnSend.addMouseListener(new MouseAdapter() {
            ...
            public void mouseReleased(MouseEvent e) {
                ...
                Loader.frameSetContent(new EnterCode().getMainPanel());

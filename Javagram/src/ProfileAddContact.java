...
public class ProfileAddContact extends LayeredPaneBlackGlass {
    ...
    public ProfileAddContact(Dimension frameDim, String title) throws IOException, FontFormatException {
        ...
        lblDesc.setFont(Loader.getMainFont(18));
        ...
        lblFindUserTitle.setFont(Loader.getMainFont(10));
        ...
        lblFindUserName.setFont(Loader.getMainFont(18));
        ...
        txtPhoneNumber.setFont(Loader.getMainFont(30));

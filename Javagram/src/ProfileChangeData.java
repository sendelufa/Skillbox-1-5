...
import forms.MyPanelBgImage;
import forms.MyTransparentSpace;
import forms.MyUnderLineText;
...
public class ProfileChangeData extends LayeredPaneBlackGlass {
    ...
    public ProfileChangeData(Dimension frameDim, String title) throws IOException, FontFormatException {
        ...
        txtName.setFont(Loader.getMainFont(30));
        ...
        txtSurname.setFont(Loader.getMainFont(30));
        ...
        lblPhoneNumber.setFont(Loader.getMainFont(24));
        lblPhoneNumber.setForeground(Color.WHITE);

        JLabel lblExit = new JLabel(" выйти ");
        lblExit.setOpaque(false);
        lblExit.setFont(Loader.getMainFont(24));

 ...
 * @author sendel
 */
@WebServlet(name = "SrvFileList", urlPatterns = {"/filelist"})
public class SrvFileList extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        } catch (FileIsNotDirectory ex) {
            Logger.getLogger(SrvFileList.class.getName()).log(Level.SEVERE, null, ex);
        }
